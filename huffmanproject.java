...
public class huffmanproject {
    ...
    // driver program -- main
        ...
        /*   
            ...
            String  get_str=str.nextLine();
               //System.out.println("\n");
            System.out.println("**************************************************************************");
            System.out.println("Encode To : ("+ get_str +"). Is -->>"+ hTree.encode(get_str)+"\n");

            //decode 'tea' -- using the actual methods built in
            System.out.println("Decode Of Bits :("+ hTree.encode(get_str) +"). Are -->> " + get_str );
           
      */
            //بصي دة بالجيواي 
           String get= JOptionPane.showInputDialog(null, "pelease enter your text?");
           JOptionPane.showConfirmDialog(null,"Encode To My Text is: \n"+hTree.encode(get) );
           JOptionPane.showConfirmDialog(null,"Decode Of ("+hTree.encode(get)+") Is :\n"+get );
           
         /* String filename="AhmedElsharkawy";
          ...
          Scanner f=new Scanner(System.in);
             ...
             try{
              ...
              BufferedWriter bf=new BufferedWriter(file);
                 System.out.println("pealse enter your text\n");
                 String w=f.next();
                 bf.write(w);
                 bf.close();
